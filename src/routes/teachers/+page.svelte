<script>
	...
	onMount(() => {
		const loadingSteps = [
			{ progress: 25, text: 'Loading teachers data', delay: 300 },
		...
		<div class="loading-content">
			<div class="loading-logo">
				...
				<svg class="logo-svg" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
					<path d="M12 2L2 7L12 12L22 7L12 2Z" fill="url(#gradient1)" stroke="url(#gradient2)" stroke-width="2"/>
					...
					<defs>
						...
						<linearGradient id="gradient2" x1="2" y1="7" x2="22" y2="17" gradientUnits="userSpaceOnUse">
			...
			<div class="loading-brand">
				<h1 class="brand-main">Teachers Management</h1>
...
<div class="teachers-page" class:visible={pageVisible}>
	<!-- Premium Page Header with Glass Morphism -->
	<div class="page-header" class:visible={pageVisible}>
		<div class="header-icon-wrapper">
			<svg class="header-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
				<path d="M18 21H6a2 2 0 0 1-2-2V9a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
				<path d="M3 9h18M9 14h6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
			</svg>
		</div>
