<script>
  ...
  onMount(async () => {
    ...
    const loadingSteps = [
      { progress: 15, text: 'Loading face recognition models...', delay: 400 },
      { progress: 35, text: 'Initializing camera systems...', delay: 600 },
      { progress: 55, text: 'Connecting to attendance server...', delay: 500 },
      { progress: 75, text: 'Preparing interface...', delay: 400 },
      { progress: 100, text: 'Ready for attendance!', delay: 300 }
    ];
  ...
  {#if !isLoading}
    ...
    <div class="content-wrapper">
      ...
      {#if currentScreen === 'login'}
        <div class="login-container" class:visible={formVisible}>
          <div class="login-header">
            ...
            <h2 class="login-title">Face Recognition</h2>
            <p class="login-subtitle">Look at the camera to sign in</p>
          </div>

          <div class="camera-section">
            <div class="camera-wrapper">
              <video bind:this={loginVideo} autoplay playsinline muted class="login-video"></video>
            ...
            <div class="login-actions">
              <button class="scan-btn" on:click={sendFrameForDetection}>
                <svg class="scan-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {#if loginMessage}
              <div class="recognition-result" class:success={loginMessageColor === 'green'} class:error={loginMessageColor === 'red'}>
                {#if loginImageUrl}
                  <img src={loginImageUrl} alt="Recognized face" class="result-image" />
                {/if}
                <div class="result-content">
                  ...
                  <div class="result-text">
                    <span class="result-message">{loginMessage}</span>
                  </div>
                </div>
              </div>
            {/if}
...
<style>
  ...
  .primary-btn:hover, .auth-submit-btn:hover {
    transform: translateY(-2px);
  ...
  .primary-btn:hover .btn-shine, .auth-submit-btn:hover .btn-shine {
    left: 100%;
  }
  ...
  /* Focus styles */
  .form-input:focus, .auth-form-input:focus, .settings-input:focus {
    outline: none;
  }

  .action-btn:focus-visible, .primary-btn:focus-visible, .secondary-btn:focus-visible,
  .scanner-btn:focus-visible, .scan-btn:focus-visible, .settings-save-btn:focus-visible,
  .back-button:focus-visible, .settings-fab:focus-visible {
