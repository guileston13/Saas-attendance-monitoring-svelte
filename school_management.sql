...
CREATE TABLE `section_subjects`  (
  ...
  `SaturdayStart` time(0) NULL DEFAULT NULL,
  `SaturdayEnd` time(0) NULL DEFAULT NULL,
  ...
  `SaturdayTeacher` int(11) NULL DEFAULT NULL,
  ...
  `SaturdayRoom` int(11) NULL DEFAULT NULL,
  ...
  INDEX `fk_section_subjects_saturday_teacher`(`SaturdayTeacher`) USING BTREE,
  ...
  CONSTRAINT `fk_section_subjects_saturday_teacher` FOREIGN KEY (`SaturdayTeacher`) REFERENCES `teachers` (`TeacherID`) ON DELETE SET NULL ON UPDATE RESTRICT,
